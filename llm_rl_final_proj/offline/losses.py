...
def compute_offline_preference_loss(
    *,
    ...
    if algo == "dpo":
        ...
        chosen_rewards, _ = torch.sort(policy_scores.chosen_logp_sum - reference_scores.chosen_logp_sum)
        rejected_rewards, _ = torch.sort(policy_scores.rejected_logp_sum - reference_scores.rejected_logp_sum)
        quantile_gap = beta * (chosen_rewards - rejected_rewards)
